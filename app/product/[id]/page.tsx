...
import VoteCount from "@/components/common-components/votecount";
import { Badge } from "@/components/ui/badge";
import { Button } from "@/components/ui/button";
import { getProductDetails } from "@/lib/cruds";
import {
  ArrowLeftIcon,
  BoxIcon,
  CalendarIcon,
...
export default async function Product({
  ...
  const { success, message, error, product } = await getProductDetails(id);
  ...
  if (success == true && product != null) {
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-24 space-y-4">
                <div className="border rounded-lg p-6 bg-background">
                  <div className="flex flex-col justify-items-center text-center mb-6">
    ...
    return <Empty title="No product found for this entry" icon={BoxIcon} />;
  }
}
